...
INSERT INTO users (id, username, email, password, display_name, profile_image_url, is_online, last_seen_at, created_at,
                   updated_at)
VALUES (1, 'alice', 'alice@example.com', 'password1', 'Alice', 'https://example.com/alice.png', true, NOW(), NOW(),
        NOW()),
       (2, 'bob', 'bob@example.com', 'password2', 'Bob', 'https://example.com/bob.png', true, NOW(), NOW(), NOW()),
       (3, 'charlie', 'charlie@example.com', 'password3', 'Charlie', 'https://example.com/charlie.png', false, NOW(),
        NOW(), NOW()),
       (4, 'david', 'david@example.com', 'password4', 'David', 'https://example.com/david.png', false, NOW(), NOW(),
        NOW()),
       (5, 'eve', 'eve@example.com', 'password5', 'Eve', 'https://example.com/eve.png', true, NOW(), NOW(), NOW()),
       (6, 'frank', 'frank@example.com', 'password6', 'Frank', 'https://example.com/frank.png', false, NOW(), NOW(),
        NOW()),
       (7, 'grace', 'grace@example.com', 'password7', 'Grace', 'https://example.com/grace.png', true, NOW(), NOW(),
        NOW()),
       (8, 'heidi', 'heidi@example.com', 'password8', 'Heidi', 'https://example.com/heidi.png', false, NOW(), NOW(),
        NOW()),
       (9, 'ivan', 'ivan@example.com', 'password9', 'Ivan', 'https://example.com/ivan.png', true, NOW(), NOW(), NOW()),
       (10, 'judy', 'judy@example.com', 'password10', 'Judy', 'https://example.com/judy.png', true, NOW(), NOW(),
        NOW());

-- Insertion de données dans la table chat_rooms
INSERT INTO chat_rooms (id, name, description, admin_id, created_at, updated_at)
VALUES (1, 'Général', 'Salon de discussion général', 1, NOW(), NOW()),
...
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (1, 'Bonjour à tous !', 1, NULL, 1, NULL, false, false, NOW(), NOW()),
...
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (6, 'Quelqu’un a testé le dernier smartphone ?', 2, NULL, 2, NULL, false, false, NOW(), NOW()),
...
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (9, 'Qui est partant pour une session de jeu ce soir ?', 5, NULL, 3, NULL, false, false, NOW(), NOW()),
...
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (12, 'Salut Bob, comment ça va ?', 1, 2, NULL, 1, false, false, NOW(), NOW()),
       (13, 'Ça va bien, merci. Et toi ?', 2, 1, NULL, 1, false, false, NOW(), NOW());

-- Conversation 2 entre Charlie (3) et David (4)
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (14, 'Salut David, on se retrouve pour un café ?', 3, 4, NULL, 2, false, false, NOW(), NOW()),
       (15, 'Bonne idée, on se tient au courant.', 4, 3, NULL, 2, false, false, NOW(), NOW());

-- Conversation 3 entre Eve (5) et Frank (6)
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (16, 'Frank, tu as vu la dernière news ?', 5, 6, NULL, 3, false, false, NOW(), NOW()),
       (17, 'Oui, c’était surprenant !', 6, 5, NULL, 3, false, false, NOW(), NOW());

-- Conversation 4 entre Grace (7) et Heidi (8)
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (18, 'Heidi, ça te dit de sortir ce weekend ?', 7, 8, NULL, 4, false, false, NOW(), NOW()),
       (19, 'Avec plaisir, on se cale ça !', 8, 7, NULL, 4, false, false, NOW(), NOW());

-- Conversation 5 entre Ivan (9) et Judy (10)
INSERT INTO messages (id, content, sender_id, recipient_id, chat_room_id, private_conversation_id, is_edited, is_read,
                      created_at, updated_at)
VALUES (20, 'Judy, tu as un moment pour discuter ?', 9, 10, NULL, 5, false, false, NOW(), NOW()),
       (21, 'Oui, dis-moi tout.', 10, 9, NULL, 5, false, false, NOW(), NOW());

-- Insertion de membres dans les salons

-- Salon "Général" (id = 1) : Alice, Bob, Charlie
INSERT INTO chat_room_member (user_id, chat_room_id)
VALUES (1, 1),
       (2, 1),
       (3, 1);

-- Salon "Tech" (id = 2) : Bob, Charlie, David
INSERT INTO chat_room_member (user_id, chat_room_id)
VALUES (2, 2),
       (3, 2),
       (4, 2);

-- Salon "Jeux" (id = 3) : Eve, Frank, Grace
INSERT INTO chat_room_member (user_id, chat_room_id)
VALUES (5, 3),
       (6, 3),
       (7, 3);

-- Salon "Musique" (id = 4) : David, Heidi, Ivan
INSERT INTO chat_room_member (user_id, chat_room_id)
VALUES (4, 4),
       (8, 4),
       (9, 4);

-- Salon "Films" (id = 5) : Judy, Alice, Frank
INSERT INTO chat_room_member (user_id, chat_room_id)
VALUES (10, 5),
       (1, 5),
       (6, 5);
